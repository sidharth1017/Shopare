$(document).ready(function(){
    ...
    if ($.isFunction($.fn.owlCarousel)) {
      //=== Top MERCHANTS Carousel ===//
      $('.top-MERCHANTS-carousel').owlCarousel({
        autoplay: false,
        smartSpeed: 600,
        loop: true,
        items: 1,
      ...
      $('.featured-Merchant-carousel').owlCarousel({
        autoplay: true,
        smartSpeed: 600,
        loop: true,
        items: 1,
      ...
      //=== Top MERCHANTS Carousel 2 ===//
      $('.top-Merchant-carousel2').owlCarousel({
        autoplay: true,
        smartSpeed: 600,
        loop: true,
        items: 6,
    ...
    if ($.isFunction($.fn.slick)) {
      //=== Merchant Detail Carousel ===//
      $('.Merchant-detail-img-carousel').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        dots: false,
        arrows: false,
        slide: 'li',
        fade: false,
        asNavFor: '.Merchant-detail-thumb-carousel'
      });        
  
      $('.Merchant-detail-thumb-carousel').slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        asNavFor: '.Merchant-detail-img-carousel',
        dots: false,
        arrows: false,
        slide: 'li',
        centerPadding: '0',
      ...
      //=== Featured Merchant Carousel ===//
      $('.featured-Merchant-grocery-img-carousel').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        dots: false,
        arrows: false,
        slide: 'li',
        fade: false,
        asNavFor: '.featured-Merchant-grocery-thumb-carousel'
      });        
  
      $('.featured-Merchant-grocery-thumb-carousel').slick({
        slidesToShow: 5,
        slidesToScroll: 1,
        asNavFor: '.featured-Merchant-grocery-img-carousel',
        dots: false,
        arrows: false,
        slide: 'li',
        centerPadding: '0',
